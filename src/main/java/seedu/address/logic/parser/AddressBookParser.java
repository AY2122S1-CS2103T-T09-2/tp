...
import seedu.address.logic.parser.modulelesson.RemarkModuleLessonCommandParser;
...
public class AddressBookParser {
    ...
    public Command parseCommand(String userInput) throws ParseException {
        ...
        case REMARK_MODULE_LESSON:
            return new RemarkModuleLessonCommandParser().parse(arguments);
